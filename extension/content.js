...
const MyCaseScraper = (() => {
  ...
  function isSearchResultsPage() {
    return window.location.href.includes('SearchResults') ||
      document.querySelector('tr.result-row') !== null;
  }

  /**
   * Check if the current page is a MyCase case summary (CCS) page.
   */
  function isCaseSummaryPage() {
    return window.location.href.includes('CaseSummary') ||
