...
- Node.js & npm (only required for running developer test suites)
...
6. Click the extension puzzle piece icon in your Chrome toolbar and pin the **Indiana Expungement Assistant** (scales of justice crest) to your toolbar.

---

## 📖 How to Use the Extension (Step-by-Step Guide)

Follow this complete walkthrough to scan your court records and generate your official expungement packet:

### Step 1: Open Indiana MyCase
1. Navigate to Indiana's official public court portal: [public.courts.in.gov/mycase/](https://public.courts.in.gov/mycase/).
2. Select **Search by Name** and enter your Last Name and First Name.
3. **Crucial Rule:** Make sure you search across **All Counties** (not just the county you currently reside in).
4. Run separate searches for any **prior legal names, maiden names, previous married names, or aliases**.

### Step 2: Open the Sidebar & Scan Records
1. While viewing your MyCase search results, click the **Indiana Expungement Assistant** extension icon in your Chrome toolbar.
2. The assistant will open in the Chrome Sidepanel on the right side of your screen.
3. Ensure the connection indicator shows a green dot: `● On MyCase Search Page`.
4. Click the blue **"Scan Page & Check Eligibility"** button.
5. The extension parses all cause numbers, filing dates, charges, and dispositions directly in your browser.
6. A **Verify Extracted Cases** confirmation dialog will appear:
   - Compare the case count and cause numbers with what you see on the MyCase page.
   - Click **"Cases Match — Continue"** to confirm.
7. **Multiple Names / Counties:** If you have records under other names or in other counties, leave **"Merge across searches"** checked and run your next search on MyCase. Click Scan again on each results page to accumulate all cases into one master lifetime petition.

### Step 3: Review Your Statutory Eligibility
1. Switch to the **Results** tab in the sidebar.
2. Review the summary metrics: **Eligible**, **Ineligible**, **Civil / Excluded**, and **Estimated Court Filing Fee**.
3. Inspect each case card to see the statutory authority governing your records:
   - **IC § 35-38-9-1:** Arrests, dismissals, dropped charges (Mandatory expungement, ≥ 1 year wait, $0 filing fee).
   - **IC § 35-38-9-2:** Misdemeanors and reduced felonies (Mandatory expungement, ≥ 5 years wait).
   - **IC § 35-38-9-3:** Non-violent Class D and Level 6 felonies (Mandatory expungement, ≥ 8 years wait).
   - **IC § 35-38-9-4 & 5:** Major felonies (Discretionary grant by presiding judge).

### Step 4: Fill Out Your Petitioner Profile
1. Switch to the **Profile** tab in the sidebar.
2. Enter your required personal identifiers:
   - Full Legal Name & Known Aliases / Maiden Names
   - Date of Birth & Social Security Number
   - Indiana Driver's License Number
   - Current Residential Address, Phone, and Email
3. Add your **10-Year Address History** (required by IC § 35-38-9-8(b)(3)):
   - Enter all prior addresses where you have lived for the past 10 years, from earliest to most recent.
   - Dates auto-format as `MM/YYYY` (or `Present` for current residence).
4. Click **"Save Profile"**.
   > *Privacy Note: All information is stored strictly in your browser's local storage (`chrome.storage.local`). Nothing is ever transmitted to any remote server or cloud database.*

### Step 5: Consult Service Directory & Generate Your Packet
1. Switch to the **Generate** tab in the sidebar.
2. **Review the Filing & Service Directory:**
   - Select your target county to view the exact verified physical addresses and phone numbers for your **County Clerk**, **Prosecuting Attorney**, **Indiana State Police**, **BMV**, and **County Sheriff**.
   - Use the **📋 Copy** buttons to copy any statutory service address directly to your clipboard.
3. Review and check each of the 4 **Mandatory Legal Acknowledgments** confirming:
   - Understanding of the Lifetime One-Shot rule (IC § 35-38-9-9(i)).
   - Verification that all cases and aliases across all 92 counties are included.
   - Non-attorney disclaimer acknowledgment.
   - Pro se representation responsibility.
4. Click the large blue **"Generate Complete Petition Packet"** button.
5. Review the final confirmation modal showing every case to be included, then click **"I Confirm All Charges Are Included"**.
6. The client-side PDF engine (`pdf-lib`) will compile all 10 official court pleadings into a unified, court-ready 14-page PDF with official per-document pagination and download it directly to your computer.

### Step 6: Sign, File, and Serve Your Documents
